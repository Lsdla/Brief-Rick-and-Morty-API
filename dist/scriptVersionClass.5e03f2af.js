  ...
  _createClass(Episode, [{
    ...
    value: function addEventInput() {
      ...
      radios.forEach(function (radio) {
        radio.addEventListener("change", function (event) {
          ...
          var number_saison = parseInt(event.target.value.replace(/\D/g, '')); // /\D/g avec ce regex on cherche tt ce qui n'est pas un nombre pour le remplacer avec une chaine de caractères vide.
    ...
    value: function createEpisodes(episodes) {
      ...
      episodes.forEach(function (episode) {
        ...
        li.querySelector("h2").addEventListener("click", _this4.showCharacters.bind(_this4)); // comme on est dans l'addEventListener le "this" renvoie normalement l'élément cliqué et avec le "bind" il renvoie le "this" de la classe et on aura ainsi accès aux attributs de la class. "Merci Denis"
